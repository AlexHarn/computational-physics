...
\begin{landscape}
	\begin{figure}
		\OverfullCenter{\includegraphics[width=\textwidth]{../A1/pos_sqrt2_zeitachse.pdf}}
...
\begin{landscape}
	\begin{figure}
		\OverfullCenter{\includegraphics[width=\textwidth]{../A1/neg_sqrt2_zeitachse.pdf}}
...
Mit den gegebenen Anfangsbedingungen erhalten wir also offensichtlich die erwarteten Eigenmoden
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{../A1/neg_sqrt2_trajektorie.pdf}
	\caption{Trajektorie für den Fall $\theta_2 = -\sqrt{2}\theta_1$.}
	\label{fig:neg_traj}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{../A1/pos_sqrt2_trajektorie.pdf}
	\caption{Trajektorie für den Fall $\theta_2 = \sqrt{2}\theta_1$.}
	\label{fig:pos_traj}
\end{figure}
...
\begin{landscape}
	\begin{figure}
		\OverfullCenter{\includegraphics[width=\textwidth]{../A2/teila.pdf}}
...
\begin{landscape}
	\begin{figure}
		\OverfullCenter{\includegraphics[width=\textwidth]{../A2/teilb.pdf}}
